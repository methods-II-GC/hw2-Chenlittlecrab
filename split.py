#!/usr/bin/env python3
"""This is a program to randomly split a tag file into three seperate files."""
...
def write_tags(path:str, data: list):
    #This function writes the content of the list generated by the generator to a textfile. 
